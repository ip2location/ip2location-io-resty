...
project = 'IP2Location.io OpenResty SDK'
...
myst_html_meta = {
    "description": "IP2Location.io OpenResty library allows user to query for an enriched data set based on IP address and provides WHOIS lookup api that helps users to obtain domain information.",
    "keywords": "IP2Location, Geolocation, IP location, OpenResty, WHOIS, domain, hosted domains",
...
html_title = "IP2Location.io OpenResty SDK"
